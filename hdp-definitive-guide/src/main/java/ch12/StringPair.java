...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StringPair\",\"namespace\":\"ch12\",\"doc\":\"A pair of strings.\",\"fields\":[{\"name\":\"left\",\"type\":\"string\"},{\"name\":\"right\",\"type\":\"string\"}]}");
  ...
  public static ch12.StringPair.Builder newBuilder() {
    return new ch12.StringPair.Builder();
  }
  
  /** Creates a new StringPair RecordBuilder by copying an existing Builder */
  public static ch12.StringPair.Builder newBuilder(ch12.StringPair.Builder other) {
    return new ch12.StringPair.Builder(other);
  }
  
  /** Creates a new StringPair RecordBuilder by copying an existing StringPair instance */
  public static ch12.StringPair.Builder newBuilder(ch12.StringPair other) {
    return new ch12.StringPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
    ...
    private Builder() {
      super(ch12.StringPair.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(ch12.StringPair.Builder other) {
      super(other);
    ...
    private Builder(ch12.StringPair other) {
            super(ch12.StringPair.SCHEMA$);
      if (isValidValue(fields()[0], other.left)) {
        this.left = data().deepCopy(fields()[0].schema(), other.left);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'left' field */
    public ch12.StringPair.Builder setLeft(java.lang.CharSequence value) {
    ...
    public ch12.StringPair.Builder clearLeft() {
      left = null;
    ...
    /** Sets the value of the 'right' field */
    public ch12.StringPair.Builder setRight(java.lang.CharSequence value) {
    ...
    public ch12.StringPair.Builder clearRight() {
      right = null;
