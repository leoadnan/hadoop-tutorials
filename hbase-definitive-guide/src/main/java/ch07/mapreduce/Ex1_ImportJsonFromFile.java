...
// Example job that reads from a file and writes into a table.
public class Ex1_ImportJsonFromFile {
  private static final Log LOG = LogFactory.getLog(Ex1_ImportJsonFromFile.class);

  public static final String NAME = "Ex1_ImportJsonFromFile";
  ...
  extends Mapper<LongWritable, Text, ImmutableBytesWritable, Mutation> {
    ...
    */
    ...
    @Override
		public void map(LongWritable offset, Text line, Context context)
			...
			try {
				...
				put.addColumn(Bytes.toBytes("data"), Bytes.toBytes("link"),Bytes.toBytes(link));
	...
	private static CommandLine parseArgs(String[] args) throws ParseException {
		...
		o = new Option("i", "input", true, "the directory in DFS to read files from");
		o.setRequired(true);
		options.addOption(o);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(Ex1_ImportJsonFromFile.class);
