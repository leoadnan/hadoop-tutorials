...
public class Ex1_SkipFilterExample {
	...
	public static void main(String[] args) throws IOException {
		...
		Filter filter1 = new ValueFilter(
				CompareFilter.CompareOp.NOT_EQUAL,
				new BinaryComparator(Bytes.toBytes("val-0")));

		Scan scan = new Scan();
		// 1-AddFilter1 Only add the ValueFilter to the first scan.
		...
		// 2-AddFilter2 Add the decorating skip filter for the second scan.
