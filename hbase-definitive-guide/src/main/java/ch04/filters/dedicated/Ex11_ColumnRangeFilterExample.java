...
//Example filtering by columns within a given range
...
public class Ex11_ColumnRangeFilterExample {
	...
	public static void main(String[] args) throws IOException {
		...
		Filter filter = new ColumnRangeFilter(
				Bytes.toBytes("col-05"), true,
