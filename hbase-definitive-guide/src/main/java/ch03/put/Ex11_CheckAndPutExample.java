...
public class Ex11_CheckAndPutExample {
	...
	public static void main(String[] args) throws IOException {
		...
		// 1- Create a new Put instance.
		put1.addColumn(Bytes.toBytes("colfam1"), Bytes.toBytes("qual1"), Bytes.toBytes("val1"));

		// 2-CAS1 Check if column does not exist and perform optional put operation.
		...
		// b-SOUT4 We will not get here as an exception is thrown beforehand!
