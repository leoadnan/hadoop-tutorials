...
// Shows what the fingerprint and ID of a data class comprises
...
public class FingerprintExample {
	...
	public static void main(String[] args) throws Exception {
		...
		String id = String.format("Hostname: %s, App: %s", InetAddress.getLocalHost().getHostName(), System.getProperty("sun.java.command"));
		put.setId(id);
