...
public class ScanExample {
	...
	public static void main(String[] args) throws IOException {
		...
		// 4-Close Close scanner to free remote resources.
		scanner1.close();

		System.out.println("Scanning table #2...");
		Scan scan2 = new Scan();
		// 5-AddColFam Add one column family only, this will suppress the retrieval of "colfam2".
		...
		Scan scan3 = new Scan();
		// 6-Build Use fluent pattern to add specific details to the Scan.
