...
public class Ex2_CheckAndMutateExample {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    helper.put("testtable",
	    	      ...
	    	      new String[] { "qual1", "qual2", "qual3", "qual4", "qual5" },
	    	      new long[]   { 1, 2, 3 },
	    	      new String[] { "val1", "val2", "val3", "val4", "val5" });
		...
		// 1-Check1 Check if the column contains a value that is less than "val1". Here we receive "false" as the value is equal, but not lesser.
		...
		// Put1 Update the checked column to have a value greater than what we check for.
		Put put2 = new Put(Bytes.toBytes("row1"));
		put2.addColumn(Bytes.toBytes("colfam2"), Bytes.toBytes("qual1"), 4, Bytes.toBytes("val2"));
		table.put(put2);

		// Check2 Now "val1" is less than "val2" (binary comparison) and we expect "true" to be printed on the console.
